...
func TestDay1_Ex1(t *testing.T) {
	assert.Equal(t, Day1P1(exD1), 142)
}

func TestDay1_Ex2(t *testing.T) {
	assert.Equal(t, Day1P2(exD1_2), 281)
}

func TestDay1_P1_Actual(t *testing.T) {
	fmt.Printf("Day 1 Part 1: %d\n", Day1P1(inputD1))
}

func TestDay1_P2_Actual(t *testing.T) {
